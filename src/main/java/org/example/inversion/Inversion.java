...
public class Inversion {
    ...
    private void mostrarMenuCriptomonedas() {
        ...
        System.out.println("Seleccione una criptomoneda para invertir:");
        ...
        if (tieneSaldoSuficiente(usuarioActual, monto)) {
            ...
            System.out.println("Inversión realizada en la criptomoneda seleccionada.");
        } else {
    ...
    private void invertirEnFondoComun() {
        ...
        if (tieneSaldoSuficiente(usuarioActual, monto)) {
            ...
            // Resta el monto del saldo usando el método restarSaldo de Cuenta
            restarSaldo(usuarioActual, monto);
    ...
    private void restarSaldo(Usuario usuario, double monto) {
        for (Cuenta cuenta : usuario.getCuentas()) {
            if (cuenta.getSaldo() >= monto) {
                cuenta.restarSaldo(monto);  // Usar el método restarSaldo de la clase Cuenta
